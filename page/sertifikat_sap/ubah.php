<?php
	$nim = $_GET['nim'];
	$sql = $koneksi->query("SELECT * FROM tb_sertifikat_sap WHERE nim = '$nim'");
	$data = $sql->fetch_assoc();
?>

<div class="panel panel-default">
    <div class="panel-heading"> Ubah Data Sertifikat Kursus SAP </div> 
...
<?php
    if (isset($_POST['simpan'])) {
        ...
        $sql = $koneksi->query("UPDATE tb_sertifikat_sap SET 
